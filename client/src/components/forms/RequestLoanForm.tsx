...
import { formatCurrency, calculateRepaymentAmount, convertToUSD, formatUSD } from '@/lib/utils';
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a loan request to borrow cryptocurrency from lenders.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="p-4 border rounded-md bg-muted">
              ...
              <div className="flex justify-between mb-2">
                ...
                <span className="font-medium">{formatCurrency(repaymentAmount, watchCurrency as Currency)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Monthly Payment</span>
                <span className="font-medium">{formatCurrency(monthlyPayment, watchCurrency as Currency)}</span>
              </div>
            </div>
